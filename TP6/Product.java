...
public class Product {
    ...
    public void addProductToStock() {
        ...
        System.out.print("Successfully added product's name: " + product.getName());
        number = number + 1;
    }
    ...
    public void removeProductByIndex() {
        ...
        while (itr.hasNext()) {
            ...
            if (i == index) {
                itr.remove();
                System.out.print(product.getName()+ " has been removed");
                check = 1;
            }
            i++;
        }
    ...
    public void updateProductInListByNumberProduct() {
        ListAllProduct();
        int check = 0;
        System.out.print("Input product's number to check: ");
        ...
        while (itr.hasNext()) {
            ...
            if (product.getNumberProduct() == numberId) {
                ...
                check = 1;
                System.out.print("Update product's name to " + nameProduct + " product is successfully");
            }
        }
        if (check == 0) {
            System.out.print("there is no number: " + numberId + " in productList");
        }
    }
